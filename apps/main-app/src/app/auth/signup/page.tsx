...
import { Mail, Lock, User, AlertCircle, Phone, CheckCircle } from 'lucide-react';
        ...
        <div className="bg-white rounded-xl shadow-lg p-8">
          ...
          {!acceptTerms && (
            <div className="mb-4 flex items-start">
              ...
              />
              <label htmlFor="terms-oauth" className="ml-2 text-sm text-gray-600">
                I agree to the{' '}
          ...
          {authMethod === 'phone' && (
            <form onSubmit={handlePhoneSignup} className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label htmlFor="firstName-phone" className="block text-sm font-medium text-brand-navy mb-2">
                    First Name
                  </label>
                  <div className="relative">
                    <User className="absolute left-3 top-1/2 -translate-y-1/2 h-5 w-5 text-gray-400" />
                ...
                <div>
                  <label htmlFor="lastName-phone" className="block text-sm font-medium text-brand-navy mb-2">
                    Last Name
                  </label>
                  <input
                    id="lastName-phone"
              ...
              <div>
                <label htmlFor="phone-signup" className="block text-sm font-medium text-brand-navy mb-2">
                  Phone Number
                </label>
                <PhoneInput
                  international
              ...
              {otpSent && (
                <div>
                  <label htmlFor="otp-signup" className="block text-sm font-medium text-brand-navy mb-2">
                    Verification Code
                  </label>
                  <input
                    id="otp-signup"
              ...
              <div className="flex items-start">
                <input
                  ...
                  className="mt-1 rounded border-gray-300 text-brand-primary focus:ring-brand-primary"
                />
                <label htmlFor="terms-phone" className="ml-2 text-sm text-gray-600">
                  I agree to the{' '}
                  <Link href="/terms" className="text-brand-primary hover:text-blue-700">
                    Terms & Conditions
                  </Link>{' '}
              ...
              <button
                type="submit"
                disabled={loading || !acceptTerms || (!otpSent && !phone) || (otpSent && !otp)}
                className="w-full bg-brand-primary text-white py-3 rounded-lg font-semibold hover:bg-blue-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {loading ? 'Processing...' : otpSent ? 'Verify & Create Account' : 'Send Code'}
              </button>
            </form>
          )}
