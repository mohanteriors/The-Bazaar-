...
- [ ] **Task 0.1.1** – Initialize monorepo (Nx/Turborepo, linting, formatting, hooks)
- [ ] **Task 0.1.2** – Create core Next.js app shells with PWA scaffolding
- [ ] **Task 0.1.3** – Scaffold shared packages (`ui`, `schemas`, `api`, `utils`)
- [ ] **Task 0.1.4** – Integrate Tailwind + shadcn UI with blue brand kit (`#35598f`)
